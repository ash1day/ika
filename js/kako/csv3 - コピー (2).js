...
function point(year,month,day,lat,lon,cpue,x,y,z,xyz,S_pathlines) {
    this.year = year;
    this.month = month;
    this.day = day;
    this.lat = lat;
...
//console.log(x_csv)
        ...
        for (i = 0; i < depth_csv; i++) {//depth
                x_csv[i][0].push(alldata[i_p][4]);
                y_csv[i][0].push(alldata[i_p][3]);
                z_csv[i][0].push(scale_z_lev[0]);
        }
        ...
        if (alldata[row_label][i][0] == axis[i_ax]) {
            ...
            for (i_d = 0; i_d < depth_csv; i_d++) {//depth for 
                ...
                if (alldata[row_label][i].slice(3,5) == name_depth) {//depth determin
                    for (i_d2 = 0; i_d2 < day_csv; i_d2++) {//depth for 
                        if (i_d2 < 10) {//
                        ...
                        if  (alldata[row_label][i].slice(1,3) == name_day) {//day determin
                            if  (i_ax == 0) {//day determin
                             //   console.log("alldata[i_p][i]" + alldata[i_p][i])
                                x_csv[i_d][i_d2+1].push(alldata[i_p][i]);
                                }
                            else if  (i_ax == 1) {//day determin
                                y_csv[i_d][i_d2+1].push(alldata[i_p][i]);
                                }
                            else if  (i_ax == 2) {//day determin
                                z_csv[i_d][i_d2+1].push(alldata[i_p][i]);
                                }
                            }                           
                        }
                    }
...
points[i_p] = new point(alldata[i_p][0],alldata[i_p][1],alldata[i_p][2],alldata[i_p][3],alldata[i_p][4],alldata[i_p][5],x_csv,y_csv,z_csv,xy_csv, S_pathline2);
